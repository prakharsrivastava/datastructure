error id: file://<WORKSPACE>/higherOrderFun/higherorderfunc.java
file://<WORKSPACE>/higherOrderFun/higherorderfunc.java
...
```java
offset: 1
uri: file://<WORKSPACE>/higherOrderFun/higherorderfunc.java
text:
```scala
o@@bject HigherOrderFunctionExample {
...
QDox parse error in file://<WORKSPACE>/higherOrderFun/higherorderfunc.java